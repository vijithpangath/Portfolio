...
exports.del = del;
exports.serve = gulp.parallel(html, ie_css, fonts_css, app_css, plugins_css, jquery_js, app_js, swiper_js, plugins_js, modernizr_js, fonts, img, uploads, img_webp, uploads_webp, watchFiles, serve);
exports.default = gulp.series(del, html, ie_css, fonts_css, app_css, plugins_css, jquery_js, app_js, swiper_js, plugins_js, modernizr_js, fonts, img, uploads, img_webp, uploads_webp);